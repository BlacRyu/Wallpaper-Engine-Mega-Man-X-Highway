...
uniform sampler2D g_Texture1; // {"default":"util/noise","material":"ui_editor_properties_noise"}

uniform sampler2D g_Texture2; // {"combo":"MASK","default":"util/white","material":"ui_editor_properties_opacity_mask","mode":"opacitymask"}
...
void main() {
	...
	vec4 albedo;
	albedo.ga = orig.ga;
	albedo.r = texSample2D(g_Texture0, v_TexCoordGlitch.xy + distortion).r-g_AudioSpectrum16Left[0]/5;
	albedo.b = texSample2D(g_Texture0, v_TexCoordGlitch.zw + distortion).b+g_AudioSpectrum16Left[0]/5;
